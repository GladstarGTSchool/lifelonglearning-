Ekoyamuo is a lifelong learning app for self development based on the interest of the user. The users are group together based on interest and rate each other writeup on a scale of 1 to 5.
...
First, you can send a mail to admin@gladstar.sch.ng to indicate your interest, why you'd like to support and what forms of support you can bring to the table, but here are areas we think we'd need the most help in this project :
